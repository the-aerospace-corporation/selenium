...
ozone_absorption_coefficients = np.loadtxt(pkg_resources.resource_filename('selenium', 'selenium/data/O3_cm2_molecule_absorption_coefficients.txt'), skiprows=1)
