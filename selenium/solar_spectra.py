...
# ASTM E490 2019
AM0_2019 = np.loadtxt(pkg_resources.resource_filename('selenium', 'data/ASTM_e490_2019_2500.txt'))
AM0_FULL_2019 = np.loadtxt(pkg_resources.resource_filename('selenium', 'data/ASTM_e490_2019.txt'))